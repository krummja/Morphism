...
class Point(tuple):
    ...
    def __new__(cls: Type[Point], x: int = 0, y: int = 0) -> Point:
        return tuple.__new__(cls, (x, y))

    def __add__(self, other: Union[Point, Size, Direction, int]) -> Point:
    ...
    def __sub__(self, other: Union[Point, Size, Direction, int]) -> Point:
